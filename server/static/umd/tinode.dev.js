          ...
          class AccessMode {
            ...
            isOwner(side) {
              return _classStaticPrivateMethodGet(
                ...
                AccessMode,
                _checkFlag
              ).call(AccessMode, this, side, AccessMode._OWNER);
            }
            ...
            isPresencer(side) {
              return _classStaticPrivateMethodGet(
                ...
                AccessMode,
                _checkFlag
              ).call(AccessMode, this, side, AccessMode._PRES);
            }
            ...
            isJoiner(side) {
              return _classStaticPrivateMethodGet(
                ...
                AccessMode,
                _checkFlag
              ).call(AccessMode, this, side, AccessMode._JOIN);
            }
            ...
            isReader(side) {
              return _classStaticPrivateMethodGet(
                ...
                AccessMode,
                _checkFlag
              ).call(AccessMode, this, side, AccessMode._READ);
            }
            ...
            isWriter(side) {
              return _classStaticPrivateMethodGet(
                ...
                AccessMode,
                _checkFlag
              ).call(AccessMode, this, side, AccessMode._WRITE);
            }
            ...
            isApprover(side) {
              return _classStaticPrivateMethodGet(
                ...
                AccessMode,
                _checkFlag
              ).call(AccessMode, this, side, AccessMode._APPROVE);
            }
            ...
            isSharer(side) {
              return (
                ...
                _classStaticPrivateMethodGet(
                  ...
                  AccessMode,
                  _checkFlag
                ).call(AccessMode, this, side, AccessMode._SHARE)
              );
            }
            ...
            isDeleter(side) {
              return _classStaticPrivateMethodGet(
                ...
                AccessMode,
                _checkFlag
              ).call(AccessMode, this, side, AccessMode._DELETE);
            }
          }
      ...
      2: [
        function (require, module, exports) {
          ...
          class CBuffer {
            ...
            getLast(at) {
              at |= 0;
              return this.buffer.length > at
                ? this.buffer[this.buffer.length - 1 - at]
                : undefined;
            }
            ...
            put() {
              ...
              for (let idx in insert) {
                _classPrivateMethodGet(
                  ...
                  _insertSorted,
                  _insertSorted2
                ).call(this, insert[idx], this.buffer);
              }
            }
            ...
            forEach(callback, startIdx, beforeIdx, context) {
              ...
              for (let i = startIdx; i < beforeIdx; i++) {
                callback.call(
                  ...
                  i < beforeIdx - 1 ? this.buffer[i + 1] : undefined,
                  i
                );
              }
            }
            ...
            find(elem, nearest) {
              const { idx } = _classPrivateMethodGet(
                this,
                _findNearest,
                _findNearest2
              ).call(this, elem, this.buffer, !nearest);
          ...
          function _findNearest2(elem, arr, exact) {
            ...
            while (start <= end) {
              pivot = ((start + end) / 2) | 0;
              diff = _classPrivateFieldGet(this, _comparator).call(
                this,
                arr[pivot],
                elem
              );
          ...
          function _insertSorted2(elem, arr) {
            const found = _classPrivateMethodGet(
              this,
              _findNearest,
              _findNearest2
            ).call(this, elem, arr, false);

            const count =
              found.exact && _classPrivateFieldGet(this, _unique) ? 1 : 0;
      ...
      3: [
        function (require, module, exports) {
          ...
          exports.VERSION =
            ...
            exports.TOPIC_SYS =
            exports.TOPIC_P2P =
            exports.TOPIC_NEW_CHAN =
            exports.TOPIC_NEW =
            exports.TOPIC_ME =
            exports.TOPIC_GRP =
            exports.TOPIC_FND =
            exports.TOPIC_CHAN =
            exports.RECV_TIMEOUT =
            exports.PROTOCOL_VERSION =
            exports.MESSAGE_STATUS_TO_ME =
            exports.MESSAGE_STATUS_SENT =
            exports.MESSAGE_STATUS_SENDING =
            exports.MESSAGE_STATUS_RECEIVED =
            exports.MESSAGE_STATUS_READ =
            exports.MESSAGE_STATUS_QUEUED =
            exports.MESSAGE_STATUS_NONE =
            exports.MESSAGE_STATUS_FAILED =
            exports.MESSAGE_STATUS_DEL_RANGE =
            exports.LOCAL_SEQID =
            exports.LIBRARY =
            exports.EXPIRE_PROMISES_TIMEOUT =
            exports.EXPIRE_PROMISES_PERIOD =
            exports.DEL_CHAR =
            exports.DEFAULT_MESSAGES_PAGE =
              void 0;
      ...
      4: [
        function (require, module, exports) {
          ...
          function _boffReconnect2() {
            ...
            const timeout =
              _BOFF_BASE *
              (Math.pow(2, _classPrivateFieldGet(this, _boffIteration)) *
                (1.0 + _BOFF_JITTER * Math.random()));

            _classPrivateFieldSet(
              this,
              _boffIteration,
              _classPrivateFieldGet(this, _boffIteration) >= _BOFF_MAX_ITER
                ? _classPrivateFieldGet(this, _boffIteration)
                : _classPrivateFieldGet(this, _boffIteration) + 1
            );
            ...
            _classPrivateFieldSet(
              ...
              setTimeout((_) => {
                _classStaticPrivateFieldSpecGet(
                  ...
                  Connection,
                  `Reconnecting, iter=${_classPrivateFieldGet(
                    this,
                    _boffIteration
                  )}, timeout=${timeout}`
                );
          ...
          function _init_lp2() {
                ...
                if (poller.readyState == XDR_DONE) {
                  if (poller.status == 201) {
                    ...
                    if (this.autoreconnect) {
                      _classPrivateMethodGet(this, _boffStop, _boffStop2).call(
                        this
                      );
                    }
                    ...
                    if (this.onDisconnect) {
                      const code =
                        poller.status ||
                        (_classPrivateFieldGet(this, _boffClosed)
                          ? NETWORK_USER
                          : NETWORK_ERROR);
                      const text =
                        poller.responseText ||
            ...
            this.connect = (host_, force) => {
              ...
              return new Promise((resolve, reject) => {
                ...
                _classStaticPrivateFieldSpecGet(
                  ...
                  Connection,
                  _log
                ).call(Connection, "LP connecting to:", url);
                ...
                _classStaticPrivateFieldSpecGet(
                  ...
                  Connection,
                  _log
                ).call(Connection, "LP connection failed:", err);
              });
            };
            ...
            this.disconnect = () => {
              ...
              if (this.onDisconnect) {
                this.onDisconnect(
                  new Error(NETWORK_USER_TEXT + " (" + NETWORK_USER + ")"),
                  NETWORK_USER
                );
              }
          ...
          function _init_ws2() {
            this.connect = (host_, force) => {
              ...
              if (_classPrivateFieldGet(this, _socket)) {
                if (
                  !force &&
                  _classPrivateFieldGet(this, _socket).readyState ==
                    _classPrivateFieldGet(this, _socket).OPEN
                ) {
                  return Promise.resolve();
                }
              ...
              return new Promise((resolve, reject) => {
                ...
                _classStaticPrivateFieldSpecGet(
                  ...
                  Connection,
                  _log
                ).call(Connection, "WS connecting to: ", url);
                ...
                conn.onclose = (evt) => {
                  ...
                  if (this.onDisconnect) {
                    const code = _classPrivateFieldGet(this, _boffClosed)
                      ? NETWORK_USER
                      : NETWORK_ERROR;
                    this.onDisconnect(
                      new Error(
            ...
            this.sendText = (msg) => {
              if (
                _classPrivateFieldGet(this, _socket) &&
                _classPrivateFieldGet(this, _socket).readyState ==
                  _classPrivateFieldGet(this, _socket).OPEN
              ) {
      ...
      5: [
        function (require, module, exports) {
          ...
          class DB {
            constructor(onError, logger) {
              ...
              _classPrivateFieldSet(
                this,
                _onError,
                onError || _classPrivateFieldGet(this, _onError)
              );
            ...
            initDatabase() {
              return new Promise((resolve, reject) => {
                ...
                req.onerror = (event) => {
                  _classPrivateFieldGet(this, _logger).call(
                    this,
                    "PCache",
                  ...
                  _classPrivateFieldGet(this, _onError).call(
                    this,
                    event.target.error
                  );
                };
            ...
            remTopic(name) {
              ...
              return new Promise((resolve, reject) => {
                ...
                trx
                  ...
                  .delete(IDBKeyRange.bound([name, "-"], [name, "~"]));
                trx
                  .objectStore("message")
                  .delete(
                    IDBKeyRange.bound(
            ...
            mapTopics(callback, context) {
              return _classPrivateMethodGet(
                ...
                _mapObjects,
                _mapObjects2
              ).call(this, "topic", callback, context);
            }

            deserializeTopic(topic, src) {
              _classStaticPrivateMethodGet(DB, DB, _deserializeTopic).call(
                DB,
                topic,
                src
              );
            ...
            mapUsers(callback, context) {
              return _classPrivateMethodGet(
                ...
                _mapObjects,
                _mapObjects2
              ).call(this, "user", callback, context);
            }
            ...
            updSubscription(topicName, uid, sub) {
              ...
              return new Promise((resolve, reject) => {
                ...
                trx
                  .objectStore("subscription")
                  .get([topicName, uid]).onsuccess = (event) => {
                  trx
                    .objectStore("subscription")
                    .put(
                      _classStaticPrivateMethodGet(
                        DB,
                        DB,
                        _serializeSubscription
                      ).call(DB, event.target.result, topicName, uid, sub)
                    );
                  trx.commit();
                };
              });
            ...
            mapSubscriptions(topicName, callback, context) {
              ...
              return new Promise((resolve, reject) => {
                ...
                trx
                  .objectStore("subscription")
                  .getAll(
                    IDBKeyRange.bound([topicName, "-"], [topicName, "~"])
                  ).onsuccess = (event) => {
                  if (callback) {
            ...
            updMessageStatus(topicName, seq, status) {
              ...
              return new Promise((resolve, reject) => {
                ...
                const req = trx
                  .objectStore("message")
                  .get(IDBKeyRange.only([topicName, seq]));
            ...
            readMessages(topicName, query, callback, context) {
              ...
              return new Promise((resolve, reject) => {
                ...
                const before =
                  query.before > 0 ? query.before : Number.MAX_SAFE_INTEGER;
                ...
                trx.objectStore("message").openCursor(range, "prev").onsuccess =
                  (event) => {
          ...
          function _deserializeTopic(topic, src) {
            _classStaticPrivateFieldSpecGet(DB, DB, _topic_fields).forEach(
              (f) => {
      ...
      6: [
        function (require, module, exports) {
          ...
          const DECORATORS = {
            ...
            IM: {
              open: (data) => {
                const tmpPreviewUrl = base64toDataUrl(
                  data._tempPreview,
                  data.mime
                );
                const previewUrl = base64toObjectUrl(
                  data.val,
                  data.mime,
                  Drafty.logger
                );
          ...
          Drafty.parse = function (content) {
            ...
            lines.forEach((line) => {
              ...
              INLINE_STYLES.forEach((tag) => {
                spans = spans.concat(
                  spannify(line, tag.start, tag.end, tag.name)
                );
              });
              let block;
          ...
          function spannify(original, re_start, re_end, type) {
            ...
            while (line.length > 0) {
              ...
              let start_offset =
                start["index"] + start[0].lastIndexOf(start[1]);
          ...
          function treeToDrafty(doc, tree, keymap) {
            ...
            if (tree.type) {
              ...
              if (Object.keys(tree.data || {}).length > 0) {
                doc.ent = doc.ent || [];
                const newKey =
                  typeof keymap[tree.key] == "undefined"
                    ? doc.ent.length
                    : keymap[tree.key];
          ...
          function lightEntity(tree, allow) {
            const lightCopy = (node) => {
              const data = copyEntData(
                node.data,
                true,
                allow ? allow(node) : null
              );
        ...
        function (require, module, exports) {
          ...
          class LargeFileHelper {
              ...
              this.xhr.onload = function () {
                ...
                if (this.status >= 200 && this.status < 300) {
                  ...
                  if (instance.toReject) {
                    instance.toReject(
                      new Error(`${pkt.ctrl.text} (${pkt.ctrl.code})`)
                    );
                  }
            ...
            upload(data, avatarFor, onProgress, onSuccess, onFailure) {
              const baseUrl =
                (this._tinode._secure ? "https://" : "http://") +
                this._tinode._host;
            ...
            download(relativeUrl, filename, mimetype, onProgress, onError) {
              if (!(0, _utils.isUrlRelative)(relativeUrl)) {
                if (onError) {
                  onError(
                    `The URL '${relativeUrl}' must be relative, not absolute`
                  );
                }
        ...
        function (require, module, exports) {
          (function (global) {
            (function () {
              ...
              var _accessMode = _interopRequireDefault(
                require("./access-mode.js")
              );

              var Const = _interopRequireWildcard(require("./config.js"));

              var _connection = _interopRequireDefault(
              ...
              var _largeFile = _interopRequireDefault(
                require("./large-file.js")
              );

              var _metaBuilder = _interopRequireDefault(
                require("./meta-builder.js")
              );
              ...
              function initForNonBrowserApp() {
                ...
                _connection.default.setNetworkProviders(
                  WebSocketProvider,
                  XHRProvider
                );
              ...
              class Tinode {
                constructor(config, onComplete) {
                  ...
                  _defineProperty(
                    this,
                    "_messageId",
                    Math.floor(Math.random() * 0xffff + 0xffff)
                  );
                  ...
                  this._connection = new _connection.default(
                    config,
                  ...
                  this._connection.onAutoreconnectIteration = (
                    timeout,
                    promise
                  ) => {
                    if (this.onAutoreconnectIteration) {
                    ...
                    this._db
                      ...
                      .then((_) => {
                        return this._db.mapTopics((data) => {
                          let topic = _classPrivateMethodGet(
                            this,
                            _cacheGet,
                            _cacheGet2
                          ).call(this, "topic", data.name);
                ...
                account(uid, scheme, secret, login, params) {
                  const pkt = _classPrivateMethodGet(
                    this,
                    _initPacket,
                    _initPacket2
                  ).call(this, "acc");
                  ...
                  if (params) {
                    ...
                    if (
                      ...
                      pkt.extra = {
                        attachments: params.attachments.filter((ref) =>
                          (0, _utils.isUrlRelative)(ref)
                        ),
                      };
                    }
                  }

                  return _classPrivateMethodGet(this, _send, _send2).call(
                    this,
                    pkt,
                    pkt.acc.id
                  );
                ...
                hello() {
                  ...
                  return _classPrivateMethodGet(this, _send, _send2)
                    .call(this, pkt, pkt.hi.id)
                    .then((ctrl) => {
                  ...
                  if (setParams) {
                    ...
                    if (setParams.desc) {
                      ...
                      if (Tinode.isNewGroupTopicName(topicName)) {
                        ...
                        Tinode.isP2PTopicName(topicName) &&
                        desc.defacs
                      ) {
                        pkt.sub.set.desc = {
                          defacs: desc.defacs,
                ...
                publishMessage(pub, attachments) {
                  ...
                  if (attachments) {
                    msg.extra = {
                      attachments: attachments.filter((ref) =>
                        (0, _utils.isUrlRelative)(ref)
                      ),
                    };
                  }
                ...
                oobNotification(data) {
                  this.logger(
                    "oob: " +
                      (this._trimLongStrings
                        ? JSON.stringify(data, jsonLoggerHelper)
                        : data)
                  );
                  ...
                  switch (data.what) {
                    case "msg":
                      ...
                      const topic = _classPrivateMethodGet(
                        this,
                        _cacheGet,
                        _cacheGet2
                      ).call(this, "topic", data.topic);
                      ...
                      if (topic.maxMsgSeq() < data.seq) {
                        ...
                        if (
                          ...
                          !_classPrivateMethodGet(
                            ...
                            _cacheGet,
                            _cacheGet2
                          ).call(this, "user", data.xfrom)
                        ) {
                          this.getMeta(
                            data.xfrom,
                            new _metaBuilder.default().withDesc().build()
                          ).catch((err) => {
                            this.logger(
                              "Failed to get the name of a new sender",
                              err
                            );
                          });
                        }
                        ...
                        topic
                          .subscribe(null)
                          .then((_) => {
                            return topic.getMeta(
                              new _metaBuilder.default(topic)
                                .withLaterData(24)
                                .withLaterDel(24)
                                .build()
                            );
                    ...
                    case "sub":
                      ...
                      let pres =
                        !acs.mode || acs.mode == _accessMode.default._NONE
                          ? {
                              what: "gone",
                              src: data.topic,
                            }
                ...
                setMeta(topic, params) {
                  ...
                  if (params) {
                    ["desc", "sub", "tags", "cred", "ephemeral"].forEach(
                      function (key) {
                  ...
                  if (what.length == 0) {
                    return Promise.reject(
                      new Error("Invalid {set} parameters")
                    );
                  }
                ...
                videoCall(topicName, seq, evt, payload) {
                  ...
                  _classPrivateMethodGet(this, _send, _send2).call(
                    this,
                    pkt,
                    pkt.note.id
                  );
                ...
                cacheRemTopic(topicName) {
                  _classPrivateMethodGet(this, _cacheDel, _cacheDel2).call(
                    this,
                    "topic",
                    topicName
                  );
                ...
                mapTopics(func, context) {
                  _classPrivateMethodGet(this, _cacheMap, _cacheMap2).call(
                    this,
                    "topic",
                    func,
                    context
                ...
                newGroupTopicName(isChan) {
                  return (
                    (isChan ? Const.TOPIC_NEW_CHAN : Const.TOPIC_NEW) +
                ...
                report(action, target) {
                  return this.publish(
                    Const.TOPIC_SYS,
                    _drafty.default.attachJSON(null, {
                      action: action,
                      target: target,
                    })
                  );
                ...
                getServerParam(name, defaultValue) {
                  return (
                    (this._serverInfo && this._serverInfo[name]) || defaultValue
                  );
                }
              ...
              function _send2(pkt, id) {
                ...
                if (id) {
                  promise = _classPrivateMethodGet(
                    this,
                    _makePromise,
                    _makePromise2
                  ).call(this, id);
                ...
                this.logger(
                  "out: " +
                    (this._trimLongStrings
                      ? JSON.stringify(pkt, jsonLoggerHelper)
                      : msg)
                );
                ...
                try {
                  ...
                  if (id) {
                    _classPrivateMethodGet(
                      ...
                      this,
                      id,
                      _connection.default.NETWORK_ERROR,
                      null,
                      err.message
                    );
                  } else {
                    ...
                    setTimeout(() => {
                      if (pkt.ctrl.code == 205 && pkt.ctrl.text == "evicted") {
                        const topic = _classPrivateMethodGet(
                          ...
                          _cacheGet,
                          _cacheGet2
                        ).call(this, "topic", pkt.ctrl.topic);
                    ...
                    setTimeout(() => {
                      if (pkt.meta) {
                        const topic = _classPrivateMethodGet(
                          ...
                          _cacheGet,
                          _cacheGet2
                        ).call(this, "topic", pkt.meta.topic);
                        ...
                        if (pkt.meta.id) {
                          _classPrivateMethodGet(
                            ...
                            _execPromise,
                            _execPromise2
                          ).call(this, pkt.meta.id, 200, pkt.meta, "META");
                        }
                        ...
                        const topic = _classPrivateMethodGet(
                          ...
                          _cacheGet,
                          _cacheGet2
                        ).call(this, "topic", pkt.data.topic);
                        ...
                        const topic = _classPrivateMethodGet(
                          ...
                          _cacheGet,
                          _cacheGet2
                        ).call(this, "topic", pkt.pres.topic);
                        ...
                        const topic = _classPrivateMethodGet(
                          ...
                          _cacheGet,
                          _cacheGet2
                        ).call(this, "topic", pkt.info.topic);
              ...
              function _attachCacheToTopic2(topic) {
                ...
                topic._cacheGetUser = (uid) => {
                  const pub = _classPrivateMethodGet(
                    this,
                    _cacheGet,
                    _cacheGet2
                  ).call(this, "user", uid);
                ...
                topic._cachePutUser = (uid, user) => {
                  _classPrivateMethodGet(this, _cachePut, _cachePut2).call(
                    this,
                    "user",
                    uid,
                    (0, _utils.mergeObj)({}, user.public)
                  );
                };
              ...
              function _loginSuccessful2(ctrl) {
                ...
                this._authenticated =
                  ctrl && ctrl.code >= 200 && ctrl.code < 300;
        ...
        function (require, module, exports) {
          ...
          class Topic {
            ...
            static topicType(name) {
              ...
              return types[
                typeof name == "string" ? name.substring(0, 3) : "xxx"
              ];
            }
            ...
            static isNewGroupTopicName(name) {
              return (
                typeof name == "string" &&
                (name.substring(0, 3) == Const.TOPIC_NEW ||
                  name.substring(0, 3) == Const.TOPIC_NEW_CHAN)
              );
            }
            ...
            static isChannelTopicName(name) {
              return (
                typeof name == "string" &&
                (name.substring(0, 3) == Const.TOPIC_CHAN ||
                  name.substring(0, 3) == Const.TOPIC_NEW_CHAN)
              );
            }
            ...
            subscribe(getParams, setParams) {
              ...
              return this._tinode
                ...
                .then((ctrl) => {
                  ...
                  this._deleted = false;
                  this.acs =
                    ctrl.params && ctrl.params.acs ? ctrl.params.acs : this.acs;
                  ...
                  if (this._new) {
                    ...
                    if (
                      this.name != Const.TOPIC_ME &&
                      this.name != Const.TOPIC_FND
                    ) {
            ...
            publishMessage(pub) {
              ...
              if (this._sending) {
                return Promise.reject(
                  new Error("The message is already being sent")
                );
              }
            ...
            delSubscription(user) {
              ...
              return this._tinode
                .delSubscription(this.name, user)
                .then((ctrl) => {
            ...
            messageVersions(message, callback, context) {
              ...
              const origSeq = this._isReplacementMsg(message)
                ? parseInt(message.head.replace.split(":")[1])
                : message.seq;
                ...
                if (startIdx != -1 && beforeIdx != -1) {
                  ...
                  msgs.forEach((val, i) => {
                    cb.call(
                      ...
                      i < msgs.length - 1 ? msgs[i + 1].data : undefined,
                      val.idx
                    );
                  });
                }
            ...
            latestMessage(skipDeleted) {
              ...
              if (
                !skipDeleted ||
                !msg ||
                msg._status != Const.MESSAGE_STATUS_DEL_RANGE
              ) {
                return msg;
              }
            ...
            _maybeUpdateMessageVersionsCache(msg) {
              ...
              let versions =
                this._messageVersions[targetSeq] ||
                new _cbuffer.default((a, b) => {
                  return a.seq - b.seq;
                }, true);
              versions.put(msg);
            ...
            _routeData(data) {
              ...
              const outgoing =
                (!this.isChannelType() && !data.from) ||
                this._tinode.isMe(data.from);

              if (
                data.head &&
                data.head.webrtc &&
                data.head.mime == _drafty.default.getContentType() &&
                data.content
              ) {
              ...
              switch (pres.what) {
                ...
                case "upd":
                  if (pres.src && !this._tinode.isTopicCached(pres.src)) {
                    this.getMeta(
                      this.startMetaQuery().withLaterOneSub(pres.src).build()
                    );
                  }
            ...
            _processMetaSub(subs) {
              for (let idx in subs) {
                ...
                this._lastSubsUpdate = new Date(
                  Math.max(this._lastSubsUpdate, sub.updated)
                );
                let user = null;
            ...
            _loadMessages(db, params) {
              const { since, before, limit } = params || {};
              return db
                .readMessages(this.name, {
                  since: since,
                  before: before,
              ...
              if (cont) {
                switch (pres.what) {
                  ...
                  case "read":
                    pres.seq = pres.seq | 0;
                    cont.read = cont.read
                      ? Math.max(cont.read, pres.seq)
                      : pres.seq;
                    cont.recv = cont.recv
                      ? Math.max(cont.read, cont.recv)
                      : cont.recv;
          ...
          class TopicFnd extends Topic {
            ...
            _processMetaSub(subs) {
              let updateCount = Object.getOwnPropertyNames(
                this._contacts
              ).length;
              this._contacts = {};
            ...
            setMeta(params) {
              return Object.getPrototypeOf(TopicFnd.prototype)
                .setMeta.call(this, params)
                .then(() => {
        ...
        function (require, module, exports) {
          ...
          function mergeObj(dst, src, ignore) {
            ...
            if (src instanceof Date && !isNaN(src)) {
              return !dst || !(dst instanceof Date) || isNaN(dst) || dst < src
                ? src
                : dst;
            }
